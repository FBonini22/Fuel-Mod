...
namespace Fuel1._1a
{
    ...
    {
        public static readonly Point     FUEL_BAR_COORDINATES    = new Point((int)((float)UI.WIDTH * 0.0125f), (int)((float)UI.HEIGHT * 0.75f));
        private static readonly int FUEL_BAR_WIDTH = (int)((float)UI.WIDTH * 0.125f);
